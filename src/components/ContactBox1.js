...
export default function ContactBox1() {
    ...
    return (
        <Box sx={{width: isNonMobile ? "300px" : "230px", 
                  height:isNonMobile ? "300px" : "230px", 
                  backgroundColor:"white", borderRadius:"10px"}}>
             <Container sx={{paddingTop:isNonMobile ? "50px" : "25px"}}>
                       <Stack direction="column" spacing={4} >
                             <Button variant="outlined" startIcon={<CallIcon />} 
                                     sx={{color:color2, fontSize:isNonMobile ? "20px" : "14px", borderColor:color2}}>
                                     +(237) 620 79 46 61
                             </Button>
                             ...
                             <Button variant="contained"
                                     ...
                                     sx={{color:"white", fontSize:isNonMobile ? "20px" : "12px", backgroundColor:color2}}>
                                    OBTENIR UN DEVIS
                             </Button>
                    </Stack>
              </Container>
