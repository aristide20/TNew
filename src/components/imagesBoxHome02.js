        ...
        <Box>
             <Grid container >
                   <Grid item xs={isScreenToBig ? 4 : isScreenBig ? 6 : 12}>
                         <Box sx={{display:"flex", justifyContent:"flex-end", alignItems:"center", height:"12rem", width:"100%"}}>
                              <img src={worker} alt="" height="100%" width="100%" />
                         </Box>
                   </Grid>
                   <Grid item xs={isScreenToBig ? 4 : isScreenBig ? 6 : 12}>
                         <Container sx={{backgroundColor: background1, display:"flex", height:"12rem",
                   ...
                   <Grid item xs={isScreenToBig ? 4 : isScreenBig ? 6 : 12}>
                         <Box sx={{display:"flex", justifyContent:"flex-start", alignItems:"center", height:"12rem", width:"100%"}}>
                              <img src={camion02} alt="" height="100%" width="100%" />
                         </Box>
                   </Grid>
                   <Grid item xs={isScreenToBig ? 4 : isScreenBig ? 6 : 12}>
                        <Container sx={{backgroundColor: background2, display:"flex", height:"12rem", width:"100%",
                   ...
                   <Grid item xs={isScreenToBig ? 4 : isScreenBig ? 6 : 12}>
                         <Box sx={{ height:"12rem", width:"100%"}}>
                              <img src={btp02} alt="" height="100%" width="100%" />
                         </Box>
                   </Grid>
                   <Grid item xs={isScreenToBig ? 4 : isScreenBig ? 6 : 12}>
                        <Container sx={{backgroundColor: background1, display:"flex", height:"12rem", width:"100%",
                                         flexDirection:"column", justifyContent:"center", alignItems:"center"}}>
                              <Typography variant="h3" sx={{textAlign:"center", fontWeight:"bold", 
                                                            color:"white", paddingTop:"40px",
                                                            paddingBottom:"40px"}}>
